...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.model.perModelFallbacks":
    "Per-model fallback chains (key: provider/model, value: ordered fallback models). Overrides global fallbacks for matched models.",
