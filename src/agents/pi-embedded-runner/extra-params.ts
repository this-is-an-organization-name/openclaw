...
} from "./proxy-stream-wrappers.js"; // tmpfix: cacheStyle
...
export function applyExtraParamsToAgent(
  ...
  // tmpfix: cacheStyle param for non-standard endpoints
  if (
    (isOpenRouterAnthropicModel(provider, modelId) &&
      effectiveExtraParams?.cacheStyle === undefined) ||
    effectiveExtraParams?.cacheStyle === "anthropic"
  ) {
